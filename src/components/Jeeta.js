...
export default function Jeeta() {
    const [hide, setHide] = useState(false)
    const [num, setNum] = useState(97)
    const [nums, setNums] = useState(11)
    ...
    return (
        <>
            <ReactPlayer id="r1" url="https://www.youtube.com/watch?v=SBfPs-PMGTA" controls={true} />
            <p id="a1">Pehla Nasha Pehla khumar Full HD l Udit Narayan,Sadhana sargam Jo jeeta<br /> wohi sikandar</p>
