...
export default function Maine() {
    ...
    return (
        <>
            <ReactPlayer id="r1" url=" https://www.youtube.com/watch?v=PhkADyPektU" controls={true} />
            <p id="a1">Aate Jaate Haste Gaate - Maine Pyar Kiya - Salman Khan & Bhagyashree -<br /> Evergreen Romantic Song</p>
            ...
            <img id='a15' onClick={gotoumar} src="https://s2.dmcdn.net/v/BW1nl1Mnr7zfzatWI/x1080"></img>
            <p id="a16">Mere Umar ke Naujavano</p>
            <img id='a17' onClick={gotomera} src="https://i.ytimg.com/vi/8sTPX0eQ_r8/maxresdefault.jpg"></img>
            <p id="a18">Aap ke aa jane se</p>
        </>
    )
}