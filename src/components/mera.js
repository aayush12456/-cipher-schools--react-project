...
export default function Mera() {
    ...
    return (
        <>
            <ReactPlayer id="r1" url="https://www.youtube.com/watch?v=tauUrxXWKCM" controls={true} />
            <p id="a1">Dil behalta hai mera aapke aa jane se- khudgarz, Govinda</p>
            <p id="a2">11M views* Mar 29 2016</p>
            {
            ...
            <img id='a15' onClick={gotomera} src="https://s2.dmcdn.net/v/BW1nl1Mnr7zfzatWI/x1080"></img>
